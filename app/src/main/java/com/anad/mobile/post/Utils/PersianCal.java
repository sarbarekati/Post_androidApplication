...
public class PersianCal implements Serializable {
    ...
    public static Calendar getGregorianCalendar(PersianCal jalali){
     ...
     * Constructor
     * */
    public PersianCal(Calendar gregorian) {
     ...
     * */
    public PersianCal(String jalaliString){
    ...
    public PersianCal(PersianCal jalali){
        setPersainCalendarWithJalali(jalali.getYear(), jalali.getMonth(), jalali.getDay(),
                jalali.getHour(), jalali.getMinute(), jalali.getSecond());
    }

    public PersianCal(int jalaliyear, int jalalimonth, int jalaliday){
        setPersainCalendarWithJalali(jalaliyear, jalalimonth, jalaliday);
    }

    public PersianCal(int jalaliyear, int jalalimonth, int jalaliday, int jalalihour,
    ...
    public boolean isEqual(PersianCal jalali){
    ...
    public int compareTo(PersianCal jalali){
