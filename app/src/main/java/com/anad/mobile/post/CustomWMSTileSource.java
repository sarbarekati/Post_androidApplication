...
/**
 * Created by elias.mohammadi on 2018/09/12.
 */

public class CustomWMSTileSource extends OnlineTileSourceBase {
     ...
     */
    public CustomWMSTileSource(String aName, String[] aBaseUrl, String layername, String version, String srs, String style, int size) {
        super(aName, 0, 22, size, "jpg", aBaseUrl);
    ...
    public static CustomWMSTileSource createFrom(WMSEndpoint endpoint, WMSLayer layer) {
        String srs = "EPSG:900913";
        if (!layer.getSrs().isEmpty()) {
            srs = layer.getSrs().get(0);
        }
        if (layer.getStyles().isEmpty()) {
            CustomWMSTileSource r = new CustomWMSTileSource(layer.getName(), new String[]{endpoint.getBaseurl()}, layer.getName(),
    ...
    public String getTileURLString(final long pMapTileIndex) {
        ...
        sb.append("&format=image/jpg&transparent=true");
        if (style != null)
